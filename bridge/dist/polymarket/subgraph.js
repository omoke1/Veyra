...
exports.PolymarketSubgraph = void 0;
...
class PolymarketSubgraph {
     ...
     */
    async getUnresolvedMarkets(limit = 100) {
        const query = `
     ...
     */
    async getMarketsReadyForResolution(limit = 50) {
...
exports.PolymarketSubgraph = PolymarketSubgraph;
